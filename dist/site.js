...
const publications = [
    ...
    { year: 2026, type: 'Artigo científico', cover: 'IJMS', journal: 'Mechanical Systems and Signal Processing', volume: 'v. 244', pages: '113747', title: 'Bandgap optimization in locally resonant metamaterial plates: A comparative study of five lattice geometries for low-frequency wave attenuation', authors: 'Ferreira, A. H. R.; Miranda Jr., E. J. P.; Goto, A. M.; Dos Santos, J. M. C.', doi: '10.1016/j.ymssp.2025.113747', link: 'https://doi.org/10.1016/j.ymssp.2025.113747', page: 'publicacoes-ijmssp-10-1016-j-ymssp-2025-113747.html', citations: [{ label: 'Scopus', value: 2, link: 'https://www.scopus.com/' }] },
    ...
    { year: 2025, type: 'Artigo científico', cover: 'IJMSE', journal: 'International Journal of Mechanical Sciences', volume: 'v. 293', pages: '110125', title: 'Wave and vibration attenuation in graded elastic metamaterial beams with local resonators', authors: 'Gomes, C. B. F.; Dos Santos, M. C. P.; Araujo, B. C. C.; Pereira, F. N.; Nobrega, E. D.; Dos Santos, J. M. C.; Miranda Jr., E. J. P.; Sinatora, A.', doi: '10.1016/j.ijmecsci.2025.110125', link: 'https://doi.org/10.1016/j.ijmecsci.2025.110125', page: 'publicacoes-ijmecs-10-1016-j-ijmecsci-2025-110125.html', citations: [{ label: 'Web of Science', value: 2, link: 'https://www.webofscience.com/' }, { label: 'Scopus', value: 22, link: 'https://www.scopus.com/' }] }
  ];
...
if (recentPublications) {
  ...
  recentPublications.innerHTML = recent.map(item => `
    <article class="publication publication-card">
      <div class="journal-cover cover-${item.cover.toLowerCase()}"><span>${item.cover}</span><small>${item.journal}</small><b>${item.year}</b></div>
      <div class="publication-body">
        <div class="publication-topline"><p class="meta">${item.type} · ${item.year}</p><span class="publication-index">${String(item.year).slice(-2)}</span></div>
