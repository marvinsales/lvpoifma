...
if (journalList) {
  const publications = [
    ...
    { year: 2026, type: 'Artigo científico', cover: 'IJMS', journal: 'International Journal of Mechanical Sciences', volume: 'v. 244', pages: '113747', title: 'Bandgap optimization in locally resonant metamaterial plates: A comparative study of five lattice geometries for low-frequency wave attenuation', authors: 'Ferreira, A. H. R.; Miranda Jr., E. J. P.; Goto, A. M.; Dos Santos, J. M. C.', doi: '10.1016/j.ymssp.2025.113747', link: 'https://doi.org/10.1016/j.ymssp.2025.113747', page: 'publicacoes-ijmssp-10-1016-j-ymssp-2025-113747.html', citations: [{ label: 'Scopus', value: 2, link: 'https://www.scopus.com/' }] },
